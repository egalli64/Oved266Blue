...
begin
    ...
    values (sysdate, :new.first_name, :new.last_name, :new.id_number, 'New user ');
 end insert_new_user;        
/
...
begin
    insert into history(history_date, h_first_name, h_last_name, h_id_number, h_description)
    values (sysdate, :new.first_name, :new.last_name, :new.id_number, 'Updated user ');
end update_user; 
/
...
begin
    insert into history(history_date, h_first_name, h_last_name, h_id_number, h_description)
    values (sysdate, :new.first_name, :new.last_name, :new.id_number, 'Deleted user id: '||:old.id_number);
end delete_user; 
/
...
insert into users(user_id, first_name, last_name, id_number)
    ...
    update users set first_name = 'Peppino' where id_number= 'CA7382oeL';
